...
export function App() {
  ...
  return (
    <div className="flex h-screen w-full flex-col bg-background text-gray-100 overflow-hidden font-sans">
      ...
      {/* Header */}
      <header className="flex items-center justify-between px-6 h-14 border-b border-white/5 bg-surface/80 backdrop-blur-md z-10 relative">
      ...
      {/* Main content grid */}
      <div className="flex flex-1 overflow-hidden relative p-4 gap-4 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-surface via-background to-background">
        
        {/* Left Sidebar - Squad selection glass panel */}
        <div className="w-80 flex flex-col gap-4 z-10 animate-fade-in">
